...
export class GuestController {
  ...
  @Get('students/:student_id/portfolio') portfolio(@Param('student_id', ParseIntPipe) studentId: number) { return { ok: true, data: { homeworks: this.guest.portfolio(studentId) } } }
